...
class SearchTest < ApplicationSystemTestCase
  ...
  test "test_1: non-logged in user functionality - search" do
    ...
    # fill in search box with fixture-equipment-specific search text, assert that proper results found div is present
    fill_in "search-box", with: "equipment_two.png" # for unknown reason only the second fixture equipment is searchable in test
    assert_equal "equipment_two.png", find("#search-box").value
